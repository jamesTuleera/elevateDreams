...
<main id="main">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="relative image-about-h4-wrap">
                        <div class="relative image-about-item about-wrap-left">
                        ...
                        <div class="relative image-about-item about-wrap-right">
                        ...
                        <div class="col-md-6">
                            <div class="icon-box-style6">
                                ...
                                <div class="content">
                                    ...
                                    <p class="des-icon">Welcome to our Print 128 wesit!
    ...
    <section class="top-this-week-about-us bg-1">
        <div class="tf-container">
            <div class="row">
                ...
                <div class="relative col-lg-12 top-this-week-slide">
                    <div class="overflow-hidden swiper populer-activities">
    ...
    <section class="mt--82 ">
        <div class="tf-container">
            <div class="relative callt-to-action flex-two z-index3">
    ...
    <!-- Widget Service -->
    <section class="relative widget-service-h5 pd-main">
        <div class="tf-container">
            <div class="mb-40 row al-i-end">
                <div class="col-md-7">
                    <div class="">
                        <span class="sub-title-heading text-main fs-28-46 font-yes">Explore the world</span>
                        <h2 class="title-heading">Great opportunity for <br><span
                                class="text-gray font-yes">adventure</span> & travels</h2>
                    </div>
                </div>
                <div class="col-md-5">
                    <p>Pellentesque habitant morbi tristique senectus netus et malesuada
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="relative tf-icon-box icon-box-style1">
                        <div class="icon">
    ...
    <!-- Widget Counter to -->
    <section class="relative counter-to">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="tf-counter center tf-countto">
                        ...
                        <p class="text-white title-counter">Happy <br>Traveller</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="tf-counter center tf-countto">
                        ...
                        <span class="line"></span>
                        <p class="text-white title-counter">Total Postive<br>Reviews</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="tf-counter center tf-countto">
                        ...
                        <span class="line"></span>
                        <p class="text-white title-counter">Tour<br>Completed</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="tf-counter center tf-countto">
                        ...
                        <div class="number-counter number" data-to="5489" data-speed="2000"
                            data-waypoint-active="yes">5489</div>
                        <span class="line"></span>
                        <p class="text-white title-counter">Awwards<br>Winning</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Widget Ig post -->
    <section class="relative instagram-post pd-main">
        <div class="tf-container">
            <div class="relative row z-index3">
                <div class="col-lg-12">
                    <div class="mb-40 center">
                        <span class="sub-title-heading text-second fs-28-46 font-yes">Explore the
                            world</span>
                        <h2 class="title-heading ">Recent instagram Post</h2>
                    </div>
                </div>
            </div>
            <div class="relative row z-index3">
