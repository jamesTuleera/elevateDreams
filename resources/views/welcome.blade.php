    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <main id="main">
                        ...
                        <div class="swiper-wrapper">
                            <div class="relative overflow-hidden slider-home1 swiper-slide">
                                <div class="silider-image">
                                    <img src="{{ asset('home_assets/assets/images/slide/slide1.jpg') }}" alt="Image" class="image-slide">
                                    <img src="{{ asset('home_assets/assets/images/slide/mask-slide.png') }}" alt="Image" class="mask-slide">
                                    <img src="{{ asset('home_assets/assets/images/slide/mask-fly.png') }}" alt="Image" class="mask-flane">
                ...
                <!-- Widget Select Form -->
                <div class="relative mt--82 z-index4 fadeInUp wow">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="relative search-form-widget-slider">
                                    <form action="/" id="search-form-slider">
                                        ...
                                        <div class="wd-search-form">
                                            <div class="input-group-grid">
                                                <fieldset class="relative group-select ">
                                                ...
                                                <fieldset class="relative group-select input-npd ">
                                                    <div class="relative search-bar-group">
                                                        <label>0</label>
                                                        <div class="nice-select" tabindex="0">
                        ...
                        <div class="row pt-35">
                            <div class="flex col-lg-12">
                                <div class="image-list flex-three">
                                    <img src="{{ asset('home_assets/assets/images/avata/6.jpg') }}" alt="Image" class="item">
                                    <img src="{{ asset('home_assets/assets/images/avata/5.jpg') }}" alt="Image" class="item">
                                    <img src="{{ asset('home_assets/assets/images/avata/4.jpg') }}" alt="Image" class="item">
                                    <img src="{{ asset('home_assets/assets/images/avata/3.jpg') }}" alt="Image" class="item">
                                    <img src="{{ asset('home_assets/assets/images/avata/1.jpg') }}" alt="Image" class="item">
                                    <img src="{{ asset('home_assets/assets/images/avata/2.jpg') }}" alt="Image" class="item">
                                    <div class="text-white icon item flex-five">
                        ...
                        <div class="row pt-115">
                            <div class="col-lg-6">
                                <div class="relative travel-video">
                                    <img src="{{ asset('home_assets/assets/images/about-us/image-video.png') }}" alt="Image" class="image-video">
                                ...
                                <div class="inner-content-about">
                                    ...
                                    <div class="row mt-27 fadeInUp wow">
                                        <div class="col-sm-6">
                                            <div class="icon-box-style3">
                                                ...
                                                <h6 class="mb-10 title"><a href="#">Trusted travel guide</a></h6>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="icon-box-style3">
                                                ...
                                                <h6 class="mb-10 title"><a href="#">Pesonalized Trips</a></h6>
                                                <p class="des">Welcome to our Print 128 wesit! company that offers a
                                                    wide r</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex-three btn-wrap-about mb-30 fadeInUp wow">
                                        ...
                                        <div class="profile flex-three">
                                            <div class="image">
                                                <img src="{{ asset('home_assets/assets/images/avata/10.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                                <img src="{{ asset('home_assets/assets/images/page/name.png') }}" alt="">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span>
                                    <h2 class="mb-40 title-heading fadeInUp wow">Amazing Featured Tour <span
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated "
                                                        ...
                                                        <a href="tour-single.html" class="tour-listing-image">
                                                            ...
                                                            <img src="{{ asset('home_assets/assets/images/travel-list/1.jpg') }}"
                                                                alt="Image Listing">
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated "
                                                        ...
                                                        <a href="tour-single.html" class="tour-listing-image">
                                                            ...
                                                            <img src="{{ asset('home_assets/assets/images/travel-list/2.jpg') }}"
                                                                alt="Image Listing">
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated "
                                                        ...
                                                        <a href="tour-single.html" class="tour-listing-image">
                                                            ...
                                                            <img src="{{ asset('home_assets/assets/images/travel-list/3.jpg') }}"
                                                                alt="Image Listing">
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="tour-listing wow fadeInUp animated "
                                                        ...
                                                        <a href="tour-single.html" class="tour-listing-image">
                                                            ...
                                                            <img src="{{ asset('home_assets/assets/images/travel-list/4.jpg') }}"
                                                                alt="Image Listing">
                ...
                <section class="relative widget-counter">
                    ...
                    <img src="{{ asset('home_assets/assets/images/page/counter-bottom.png') }}" alt="image" class="counter-bottom">
                    <div class="tf-container">
                        <div class="row mb-50">
                ...
                <section class="widget-destination">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-40 center m0-auto w-text-heading">
                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span>
                        ...
                        <div class="grid-three-destination">
                            <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.1s">
                                <a href="single-destination.html" class="destination-imgae">
                                    ...
                                    <img src="{{ asset('home_assets/assets/images/destination/list.jpg') }}" alt="">
                                </a>
                            ...
                            <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.2s">
                                <a href="single-destination.html" class="destination-imgae">
                                    ...
                                    <img src="{{ asset('home_assets/assets/images/destination/list1.jpg') }}" alt="">
                                </a>
                                <div class="destination-content">
                            ...
                            <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.3s">
                                <a href="single-destination.html" class="destination-imgae">
                                    ...
                                    <img src="{{ asset('home_assets/assets/images/destination/list2.jpg') }}" alt="">
                                </a>
                                <div class="destination-content">
                            ...
                            <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.4s">
                                <a href="single-destination.html" class="destination-imgae">
                                    ...
                                    <img src="{{ asset('home_assets/assets/images/destination/list3.jpg') }}" alt="">
                                </a>
                                <div class="destination-content">
                            ...
                            <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.5s">
                                <a href="single-destination.html" class="destination-imgae">
                                    <span class="tour">3 tours</span>
                                    <img src="{{ asset('home_assets/assets/images/destination/list4.jpg') }}" alt="">
                                </a>
                                <div class="destination-content">
                                        ...
                                        <div class="tab-pane fade show active" id="nav-hiking" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour1.jpg') }}" alt="">
                                                        </a>
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour2.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour3.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour4.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour5.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour6.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour7.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        <a href="tour-single.html" class="adventure-image">
                                                            <img src="{{ asset('home_assets/assets/images/tour/tour8.jpg') }}" alt="">
                                                        </a>
                                                        <div class="adventure-image">
                                                            <span class="tour-ad">(3 Tour)</span>
                                                            <h6 class="title-ad"><a
                            ...
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">Explore the
                                        world</span>
                                    <h2 class="mb-40 title-heading wow fadeInUp animated">Latest news & articles <span
