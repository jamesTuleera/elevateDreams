  ...
  <div>
            ...
            <div class="header-lower">
              <div class="tf-container full">
                <div class="row">
                  <div class="col-lg-12">
                    <div
                      class="flex inner-container justify-space align-center"
                    >
                      <!-- Logo Box -->
                      ...
                      <div class="logo-box">
                        <div class="logo">
                          <a href="index.html">
                            <img
                              src="/home_assets/assets/images/logo.png"
                              alt="Logo"
                            />
                          </a>
                        </div>
                      ...
                      <div class="flex nav-outer align-center">
                        ...
                        <nav class="main-menu show navbar-expand-md">
                          <div
                            class="clearfix navbar-collapse collapse"
                      ...
                      <div class="flex header-account align-center">
                        <div class="language">
                          <div class="nice-select" tabindex="0">
                            <img
                              src="/home_assets/assets/images/page/language.svg"
                              alt=""
                          ...
                          <ul class="flex align-center">
                            <li>
                              <a href="login.html" class="flex-three">
                                <img
                                  src="/home_assets/assets/images/page/avata.jpg"
                                  alt="image"
                                />
                              </a>
                            </li>
              ...
              <img
                src="/home_assets/assets/images/page/fl1.png"
                alt=""
                class="fly-ab"
              />
            </div>
          ...
          <div class="mobile-menu">
            ...
            <nav class="menu-box">
              <div class="nav-logo">
                <a href="index.html">
                  <img
                    src="/home_assets/assets/images/logo2.png"
                    alt=""
                /></a>
              </div>
            ...
            <div class="tf-container">
              <div class="row">
                <div class="relative col-md-5">
                  <div
                    class="image-box-tesimonial box-testimonial1 wow fadeInLeft animated"
                    data-wow-delay="0.1s"
                  >
                    <img
                      src="/home_assets/assets/images/page/testimonial1.jpg"
                      alt=""
                    />
                  </div>
                  <div
                    class="image-box-tesimonial box-testimonial2 wow fadeInUp animated"
                    data-wow-delay="0.3s"
                  >
                    <img
                      src="/home_assets/assets/images/page/testimonial2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                        ...
                        <div class="swiper-slide">
                          <div class="relative testimonial-content">
                            ...
                            <p class="tes">
                              ...
                              approaches to corporate strategy data foster go to
                    ...
                    <div class="swiper testimonial-image">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide avata">
                          <img
                            src="/home_assets/assets/images/avata/9.jpg"
                            alt="Image Testimonial"
                          />
                        </div>
                        <div class="swiper-slide avata">
                          <img
                            src="/home_assets/assets/images/avata/7.jpg"
                            alt="Image Testimonial"
                          />
                        </div>
                        <div class="swiper-slide avata">
                          <img
                            src="/home_assets/assets/images/avata/8.jpg"
                            alt="Image Testimonial"
                          />
                        </div>
                      </div>
            ...
            <div class="tf-container">
              <div class="relative row z-index3">
                <div class="col-lg-7 content-banner-contact">
                  <div class="mb-32">
                    <span
                      class="sub-title-heading text-main mb-15 font-yes fs-28-46 wow fadeInUp animated"
                      >Explore the world</span
                    >
                    <h2 class="text-white title-heading wow fadeInUp animated">
                  ...
                  <div class="flex-three">
                    ...
                    <address class="wow fadeInUp animated">
                      Contact us at
                      <a href="mailto:@Hooktheme.co"> @Hooktheme.co</a><br />
                    </address>
                  </div>
                  <img
                    src="/home_assets/assets/images/page/vector2.png"
                    alt="image"
                    class="mask-icon-banner"
                  />
                </div>
                <div class="col-lg-5">
                  <div class="image-banner-contact">
                    <img
                      src="/home_assets/assets/images/page/ewewe1.png"
                      alt=""
                    />
                  </div>
                </div>
            ...
            <div class="tf-container">
              <div class="callt-to-action flex-two">
                <div class="callt-to-action-content flex-three">
                  <div class="image">
                    <img
                      src="/home_assets/assets/images/page/ready.png"
                      alt="Image"
                    />
                  </div>
                  <div class="content">
                ...
                <img
                  src="/home_assets/assets/images/page/vector4.png"
                  alt=""
                  class="shape-ab"
                />
          ...
          <div class="tf-container">
            <div class="footer-main">
              ...
              <div class="footer-gallery">
                ...
                <div class="gallery-img">
                  <a
                    href="/home_assets/assets/images/gallery/gl1.jpg"
                    data-fancybox="gallery"
                  >
                    <img
                      src="/home_assets/assets/images/gallery/gl1.jpg"
                      alt="image gallery"
                    />
                  </a>
                  <a
                    href="/home_assets/assets/images/gallery/gl2.jpg"
                    data-fancybox="gallery"
                  >
                    <img
                      src="/home_assets/assets/images/gallery/gl2.jpg"
                      alt="image gallery"
                    />
                  </a>
                  <a
                    href="/home_assets/assets/images/gallery/gl3.jpg"
                    data-fancybox="gallery"
                  >
                    <img
                      src="/home_assets/assets/images/gallery/gl3.jpg"
                      alt="image gallery"
                    />
                  </a>
                  <a
                    href="/home_assets/assets/images/gallery/gl4.jpg"
                    data-fancybox="gallery"
                  >
                    <img
                      src="/home_assets/assets/images/gallery/gl4.jpg"
                      alt="image gallery"
                    />
                  </a>
                  <a
                    href="/home_assets/assets/images/gallery/gl5.jpg"
                    data-fancybox="gallery"
                  >
                    <img
                      src="/home_assets/assets/images/gallery/gl5.jpg"
                      alt="image gallery"
                    />
                  </a>
                  <a
                    href="/home_assets/assets/images/gallery/gl6.jpg"
                    data-fancybox="gallery"
                  >
                    <img
                      src="/home_assets/assets/images/gallery/gl6.jpg"
                      alt="image gallery"
                    />
                  </a>
                </div>
            ...
            <div class="row footer-bottom">
              <div class="col-md-6">
                <p class="copy-right">
                  Copyright © 2024 by
                  <a href="#" class="text-main">Themesflat.</a> All Rights
                  Reserved
                </p>
              </div>
              <div class="col-md-6">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight">
      ...
      <div class="offcanvas-body">
        ...
        <p class="des">
          The world’s first and largest digital market for crypto collectibles
          and non-fungible
        </p>
